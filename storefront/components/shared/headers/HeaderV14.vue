<template>
    <header :class="['ps-header ps-header--11 ps-header--14', { 'ps-header--sticky': sticky }]">
        <div class="ps-header__middle">
            <div class="container">
                <div class="ps-logo">
                    <nuxt-link to="/"> 
                        <img src="/img/logo-dark.png" alt>
                        <img class="sticky-logo" src="/img/logo-dark.png" alt>
                    </nuxt-link>
                </div>
...
import { menuHome11 } from '~/static/data/menu.json';
