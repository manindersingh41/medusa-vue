                ...
                <div class="row row-reverse">
                    <div class="col-12 col-md-9">
                        ...
                        <div class="ps-categogy__loading">
                            <p>You're viewed {{products.length}} of 62 products </p>
                            <div class="load-wrapp" v-if="loadMore">
                                <div class="ring-2">
                            ...
                            <button class="ps-btn ps-btn--primary" v-else @click="handleLoadMore()">Load more</button>
                        </div>
                        <delivery />
                    </div>
